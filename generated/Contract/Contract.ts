...
export class Contract__idToEventResult {
  value0: Bytes;
  value1: string;
  value2: Address;
  value3: BigInt;
...
export class Contract extends ethereum.SmartContract {
  ...
  idToEvent(param0: Bytes): Contract__idToEventResult {
    ...
    return new Contract__idToEventResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_idToEvent(param0: Bytes): ethereum.CallResult<Contract__idToEventResult> {
